...
export async function getAllQuizzes(req, res) {
  try {
    ...
    console.error("Get all quizzes error:", err.message);
    if (err.message === "Unauthorized") return res.status(401).json({ message: err.message });
    if (err.message === "Forbidden") return res.status(403).json({ message: err.message });
...
e:internal/modules/esm/resolve:275
    throw new ERR_MODULE_NOT_FOUND(
          ^

Error [ERR_MODULE_NOT_FOUND]: Cannot find module 'C:\Users\ACER\OneDrive\Documents\Desktop\Quiz App\server\controllers\quiz.controller' imported from C:\Users\ACER\OneDrive\Documents\Desktop\Quiz App\server\routes\quizRoutes.js
  ...
  url: 'file:///C:/Users/ACER/OneDrive/Documents/Desktop/Quiz%20App/server/controllers/quiz.controller'
}