...
// GET /api/quizzes/mysubmissions
// Returns all submissions for the logged-in user
router.get('/mysubmissions', authenticateJWT, async (req, res) => {
  const email = req.user.email;
  const submissions = await Submission.find({ email }); // or however you store them
