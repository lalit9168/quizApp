...
import {
  ...
  Accordion, AccordionSummary, AccordionDetails, Tooltip, Fade
} from '@mui/material';
      ...
      <Fade in timeout={700}>
        ...
        >
          ...
          <TextField
            ...
            sx={{ mb: 4 }}
            InputLabelProps={{ style: { color: "#00feba" } }}
          ...
          {questions.map((q, i) => (
            <Paper
              ...
              sx={{
                mb: 3,
                p: 3,
                backgroundColor: "rgba(0,254,186,0.05)",
                border: "1px solid rgba(0,254,186,0.2)",
                borderRadius: 3,
              }}
            >
              <Typography variant="h6" sx={{ color: "#5b86e5", mb: 2 }}>
                Question {i + 1}
              </Typography>
          ...
          <Typography variant="h5" gutterBottom sx={{ color: "#00feba" }}>
