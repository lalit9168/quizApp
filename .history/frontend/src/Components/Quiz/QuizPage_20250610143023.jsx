  ...
  try {
    ...
    const res = await api.post(
      ...
      { 
        ...
        questions, 
        duration,
        adminEmail: decodedToken.email, // Include the admin's email from the decoded JWT
        adminRole: decodedToken.role,   // Include the admin's role from the decoded JWT (if necessary)
      },
      {
        headers: {
