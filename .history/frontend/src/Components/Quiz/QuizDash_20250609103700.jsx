        ...
        <Grid container spacing={4}>
          {quizzes.map((quiz) => (
            <Grid item xs={12} sm={6} md={4} key={quiz._id}>
              // Just REPLACE the full QuizDash component with this one 👇
...
<Card
  ...
  sx={{
    ...
    cursor: "pointer",
    background: `linear-gradient(135deg, #fff1f8 0%, #ffe6ec 100%)`,
    "&:hover": {
      transform: "translateY(-8px)",
      boxShadow:
        "0 12px 20px rgba(255, 105, 180, 0.3), 0 10px 40px rgba(255, 20, 147, 0.2)",
    },
    height: "100%",
    display: "flex",
...
>
  <Box>
    <Stack direction="row" alignItems="center" spacing={1} mb={1}>
      <QuizIcon sx={{ color: "#D81B60" }} fontSize="large" />
