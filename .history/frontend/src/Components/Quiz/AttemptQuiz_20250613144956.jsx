...
const submitQuiz = async () => {
  ...
  try {
    ...
    const pdfBase64 = pdfDoc.output("datauristring").split(",")[1]; // Get base64 content only
    const fileName = "scorecard.pdf";

    // Step 5: Decode JWT token to get email and name
    const decodedToken = JSON.parse(atob(token.split(".")[1]));
    ...
    // Step 6: Send email with PDF attached using EmailJS
    await emailjs.send(
