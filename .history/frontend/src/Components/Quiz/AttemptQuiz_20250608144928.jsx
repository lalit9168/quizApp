...
function AttemptQuiz() {
  ...
  useEffect(() => {
    const fetchQuiz = async () => {
      try {
        ...
        const duration = quizData.duration; // in minutes
        ...
        // Handle persistent timer using localStorage
  ...
  // ✅ Fix: Stop and remove timer when quiz ends manually
  if (timerRef.current) {
    clearInterval(timerRef.current);
  }
  localStorage.removeItem(`quizStartTime_${code}`);
  setTimeLeft(null); // ✅ Hides timer from the UI
};
