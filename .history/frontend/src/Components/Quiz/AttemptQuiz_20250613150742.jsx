...
const submitQuiz = async () => {
  ...
  try {
    ...
    downloadPDF(pdfDoc); // your function that adds content
    const pdfBase64URI = pdfDoc.output("datauristring");
    ...
    // Step 5: Send email with title + PDF attachment
    await emailjs.send(
      "service_xsl27oo",
      "template_g8c6hfe",
      {
        ...
        title: quiz.title, // ✅ send title here
      },
      {
        publicKey: "amqojsEuLsl4OgVm1",
        attachments: [
          {
            name: "scorecard.pdf",
            data: pdfBase64URI,
