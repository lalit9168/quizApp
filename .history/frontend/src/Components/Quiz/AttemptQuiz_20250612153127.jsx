...
import "jspdf-autotable"; // Change this import
import api from "../api";
...
function AttemptQuiz() {
  ...
  emailjs
    .send(
      ...
      "template_g8c6hfe", // 🔁 Replace this with your actual template ID
      templateParams,
      "KDOP8W9aCiO1Omj2E"   // 🔁 Replace this with your actual public key
    )
    .then((res) => {
