...
function AttemptQuiz() {
  ...
  const downloadPDF = () => {
    ...
    const templateParams = {
      to_email: email,
      to_name: name,
      from_name: "QuizApplication Team",
      quiz_title: quiz.title,
      score: `${score} / ${quiz.questions.length}`,
      percentage: `${percentage}%`,
      message: `Congratulations ${name}! Your quiz results are ready. Please find your detailed scorecard attached.`,
      pdf_base64: pdfBase64,
      file_name: filename,
    };

    // Initialize EmailJS with your public key
    emailjs.init("KDOP8W9aCiO1Omj2E"); // Replace with your actual public key

    emailjs
      .send(
        "service_xsl27oo", // Replace with your actual service ID
        "template_g8c6hfe", // Replace with your actual template ID
        templateParams
      )
      .then((response) => {
