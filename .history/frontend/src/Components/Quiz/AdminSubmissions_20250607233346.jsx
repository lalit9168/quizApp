...
function AdminSubmissions() {
  ...
  const shareToWhatsApp = (quizCode) => {
    const phoneNumber = "919168018581"; // Replace with your number, no '+'
    const message = `Hey! Here's the quiz code: ${quizCode}`;
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    <Button
                      ...
                      color="success"
                      size="small"
                      onClick={() => shareToWhatsApp("ABC123")}
                    >
                      Share
                    </Button>
                  </TableCell>
                ...
                {submissions.map((quiz) =>
                  quiz.submissions.map((sub, idx) => (
                    <TableRow key={`${quiz.quizCode || 'unknown'}-${idx}`}>
                      <TableCell>{quiz.title}</TableCell>
                      ...
                      <TableCell>
                        <Button
                          ...
                          color="success"
                          size="small"
                          onClick={() => shareToWhatsApp(quiz.quizCode)}
                        >
                          Share
                        </Button>
                      </TableCell>
