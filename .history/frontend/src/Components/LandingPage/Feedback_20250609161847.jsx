...
const Feedback = () => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs
      .sendForm("service_b20b3tk", "template_9ce9qog", form.current, "KDOP8W9aCiO1Omj2E")
      .then(() => {
        setOpen(true);
        form.current.reset();
      })
  ...
  const bubbles = [
    ...
    { size: 80, top: "30%", left: "50%", delay: 2 },
  ];
    ...
    <>
      ...
      <Box sx={styles.root}>
        ...
        {bubbles.map((b, i) => (
          <motion.div
            key={i}
            style={bubbleBase(b.size, b.top, b.left)}
        ...
        <Container maxWidth="sm" sx={{ position: "relative", zIndex: 2 }}>
          ...
          >
            <Paper elevation={6} sx={styles.formPaper}>
